  ...
  return (
    ...
    <Container className='w-100 page  d-flex flex-column justify-content-center'>
        ...
        <div className='d-inline-flex flex-column justify-content-between p-2 h-100'>
          ...
          <Link to={'/shop'} className='d-flex align-items-center justify-content-between p-2' style={{background:'#D9D9D9',color:'black'}}>Go To Shop <img width={'50px'} src={require('../../assets/images/icons/arrow.png')} /></Link>
        </div>
        </Col>
        <Col xs={12} md={8}>
